                            ...
                            <table className="min-w-full divide-y divide-gray-200 text-xs sm:text-sm">
                                <thead className="bg-gray-50 text-gray-600 font-medium">
                                    <tr>
                                        ...
                                        <th className="px-4 sm:px-6 py-3 text-left">Keterangan</th>
                                    </tr>
                                </thead>
                                    ...
                                    {requests?.data?.length > 0 ? (
                                               ...
                                               <td className="px-4 sm:px-6 py-3">
                                                    {req.status === 'rejected' && req.rejection_reason ? (
                                                        <div className="max-w-xs">
                                                            <span 
                                                                className="text-red-600 text-xs block cursor-help" 
                                                                title={`Alasan penolakan: ${req.rejection_reason}`}
                                                            >
                                                                
                                                                {req.rejection_reason.length > 50 
                                                                    ? `${req.rejection_reason.substring(0, 50)}...` 
                                                        ...
                                                        <span className="text-green-600 text-xs">
                                                            ...
                                                            {req.approver?.name ? `oleh ${req.approver.name}` : ''}
                                                        </span>
                                                    ) : (
                                        ...
                                        <tr>
                                            <td colSpan={10} className="px-4 sm:px-6 py-8 text-center text-gray-500">
                                                Tidak ada data permintaan barang keluar
                                            </td>
                                        </tr>
                                    )}
                                </tbody>
